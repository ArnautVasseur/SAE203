<template>
  <div class="flex-col flex mt-7 md:flex-row md:items-center md:h-[320px] md:mb-10">
    ...
    <!--CAROUSEL-->
      <div class="bg-dark_gray light:bg-light_gray text-white light:text-black -skew-y-6 -mt-10 mb-24 h-60 w-full inline-block sm:skew-y-0 md:mb-0 md:h-full md:mt-0"> 
    ...
    <div class=" flex flex-col md:flex-row-reverse md:h-[320px] md:mt-10">
      <div class="md:h-[320px] md:w-1/2">
          <h2 class="mb-5 text-center text-3xl font-bold font-metal-mania mx-5 light:text-white">Ne manquez pas vos artistes préférés !</h2>
          <div class="flex mb-32 mx-8 items-center justify-around">
              <p class="text-2xl font-medium font-mulish light:text-white">consulter le détail du <router-link to="/programme"><span class="underline">programme ici:</span></router-link></p>
              <router-link to="/programme">
                  <img src="../assets/images/calendar.webp" alt="calendar" class="w-32">
              </router-link>
          </div>
      </div>
      <div class="bg-dark_gray light:bg-light_gray text-white light:text-black skew-y-12 py-10 -mt-10 mb-10 inline-block w-full sm:skew-y-0 md:h-[320px] md:w-1/2 md:pt-14"> 
    ...
    <router-link to="styleguide">
      <p class="text-center light:text-white mb-44">Guide de style</p>
    </router-link>
    <!--footer-->
