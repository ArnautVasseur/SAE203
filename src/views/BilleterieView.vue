<template>
    <div class="bg-dark_gray light:bg-light_gray text-white light:text-black -skew-y-6 mt-10 w-full h-[930px] sm:skew-y-0"> 
    ...
    <h2 class="text-center mt-10 text-black light:text-white mb-10 font-bold font-metal-mania text-3xl">Formules</h2>
    ...
    <p class="mb-5 text-center mt-10 text-2xl font-semibold font-mulish light:text-white">Retour en haut de la page</p>
