  ...
  <div class="bg-dark_gray light:bg-light_gray text-white light:text-black -skew-y-6 mt-10 mb-24 inline-block w-full sm:skew-y-0"> 
    <div class="skew-y-6 mx-8 text-center text-2xl pb-16 sm:skew-y-0 sm:mx-32">
        ...
        <div class="bg-light_gray light:bg-dark_gray w-full p-5 rounded-xl text-black text-lg font-medium sm:font-semibold font-mulish">
          ...
          <p class="my-5">Alaways</p>
          <p class="my-5">I’ll Be There For You</p>
          <p class="my-5">Bed Of Roses</p>
          <p class="my-5">This Ain’t a Love Songs</p>
          <p class="my-5">Thank You For Loving Me</p>
          <p class="my-5">Never Say Goodbye</p>
          <p class="my-5">Keep The Faith</p>
          <p class="my-5">Blaze Of Glory</p>
          <p class="my-5">You Want To Make A Memory</p>
          <p class="my-5">Born A Nice Day</p>
          <p class="my-5">We Weren’t Born To Follow</p>
          <p class="my-5">Misunderstood</p>
          <p class="my-5">This House Is Not For Sale</p>
          <p class="my-5">Dry County</p>
        </div>
    </div>
  </div>
  <!--Design effect-->
